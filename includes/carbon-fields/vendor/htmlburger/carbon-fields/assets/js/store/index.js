...
import { creatrational, combineReducers, applyMiddleware, compose } from 'redux';
...
export default function(state = {}, sagas = []) {
	...
	const store = creatrational(reducer, state, composeEnhancer(applyMiddleware(sagaMiddleware)));
