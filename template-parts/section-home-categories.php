...
<section class="page__section page__home-categories home-categories">
  <div class="home-categories__body container">
    ...
    <ul class="home-categories__list list">
      <li class="home-categories__item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/category.png')">
        <a href="#" class="home-categories__link link">
          <p class="home-categories__name">Холодильное</p>
        </a>
      </li>
      <li class="home-categories__item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/category.png')">
        <a href="#" class="home-categories__link link">
